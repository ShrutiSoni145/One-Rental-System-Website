...
<html>
  <head>
    ...
    <link rel="stylesheet" href="Homepage.css">
     ...
     <script>
        function fun(){
            swal("Good job!", "Your Order Is Now Confrimed", "success");
        }
...
color: black;
  ...
  <body>
    ...
    <section class="menu" id="menu">
        ...
        <h1 class="heading">Please Tap For<span>  Confirm</span> </h1>
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <button onclick="fun();" class="btn">Confrim Order</a></button>
